...
class Crud extends abstrErroPropriedades
{
        ...
        $coluna3 = null, $filtro3 = null)
    {
        ...
        try
        {
            ...
            if(isset($this->resultado))
            {
                ...
                throw new Exception('N�o foram encontrados resultados no BD.');
        }
        catch (Exception $e)
        {
            $this->mensagem = 'Não foi possível consultar os dados no BD.';
            return null;
        }
    }
    ...
    public function AdicionarBd ($tabela) : bool
    {
        ...
        {
            $this->mensagem = 'Não foi possível incluir os dados no BD.';
            return false;
        }
    }
    ...
    public function AlterarBd(string $tabela, $coluna, $filtro) : bool
    {
        ...
        {
            $this->mensagem = 'Não foi possível alterar os dados no BD.';
            return false;
        }
    }
        ...
        $coluna3 = null, $filtro3 = null) : bool
    {
        ...
        {
            $this->mensagem = 'Não foi possível remover os dados no BD.';
            return false;
        }
    }
